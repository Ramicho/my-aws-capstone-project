...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c1opr7au6hpt.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'ramoblock' # please enter your s3 bucket name
