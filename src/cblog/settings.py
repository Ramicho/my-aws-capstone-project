...
DATABASES = {
    'default': {
        ...
        'HOST': 'rds-private1a.c1opr7au6hpt.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsdevopsacademy.com' # please enter your s3 bucket name
